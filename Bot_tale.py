...
async def generate_story(data):
   ...
   - Длина сказки не менее 1000 и не более 1400 символов. Обязательно соблюдай эту длину!""",
...
"2":"""Для возраста 3-5 лет:
   ...
   - Добрый юмор
   - Длина сказки не менее 2400 и не более 2800 символов. Обязательно соблюдай эту длину!""",
...
"3":"""Для возраста 6-8 лет:
   ...
   - Длина сказки не менее 3000 и не более 3800 символов. Обязательно соблюдай эту длину!"""}
...
Обязательно соблюдай требуемую длину сказки!
ВАЖНО: длина сказки не должна превышать 4000 символов!
ВАЖНО: в сказке должны быть только слова и буквы на русском языке!
В конце выведи количество всех символов сказки с (учетом пробелов и символов переноса).
Также в конце выводи количество всех токенов сказки"""
