...
async def generate_story(data):
   ...
   - Длина сказки не менее 1400 символов. Обязательно соблюдай эту длину!""",
...
"2":"""Для возраста 3-5 лет:
   ...
   - Добрый юмор
   - Длина сказки не менее 2800 символов. Обязательно соблюдай эту длину!""",
...
"3":"""Для возраста 6-8 лет:
   ...
   - Длина сказки не менее 3500 символов. Обязательно соблюдай эту длину!"""}
...
Выводи в конце количество всех токенов сказки"""
